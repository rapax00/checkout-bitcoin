...
const urlTelegramGroup = process.env.TELEGRAM_GROUP_URL;
    ...
    <html lang="es">
      ...
      <body>
        <div class="container">
          ...
          <p>Te esperamos en: <br>📍 Villanueva 1367, Belgrano, CABA. <br>🗓️ Sábado 02/11 después de LABITCONF <br>⏰ A partir de las 22:00 hs.</p>
